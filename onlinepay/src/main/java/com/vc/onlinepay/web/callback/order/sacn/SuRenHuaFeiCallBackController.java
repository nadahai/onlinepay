 ...
 */
@RestController
@RequestMapping("/suRenHuaFeiCallBackController")
public class SuRenHuaFeiCallBackController extends BaseController {
    ...
    public String invokeCallback(HttpServletRequest request) {
    	try {
            ...
            logger.info("俗人话费回调接口接收参数2:{}", request.toString());
            logger.info("俗人话费回调接口接收参数getParameter:{}", request.getParameter("orderid"));
            //logger.info("俗人话费回调接口接收参数getAttribute:{}", request.getAttribute("orderid"));
            if (request.getParameter("orderid") == null || request.getParameter("orderid").isEmpty()){
                logger.error("俗人话费回调接口获取参数为空");
            ...
            if (StringUtil.isEmpty(vcOrderNo) || vcOnlineOrder==null) {
                logger.error("俗人话费回调接口订单号为空{}", vcOrderNo);
                return Constant.res_FAILED;
            }
            ...
            String sourctxt1 = Md5CoreUtil.getSignStr(parms)+"&key=m73xywn6q30vc5tpap7c4g83czxa7w35";
            ...
            if (isOK) {
                ...
                logger.error("俗人话费回调接口更新失败{}", request.toString());
                return Constant.res_FAILED;
            }
        } catch (Exception e) {
            logger.error("俗人话费回调接口业务处理异常", e);
