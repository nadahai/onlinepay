...
@Controller
@RestController
@RequestMapping("/eYuCallBackController")
public class EYuCallBackController extends BaseController {
    ...
    public String invokeCallback(HttpServletRequest request) throws IOException {
        ...
        try {
            ...
            if (isOk) {
                ...
                logger.error("鳄鱼PDD回调结果{}更新失败{}",isOk,requestMap);
                return "ERROR";
            }
        } catch (Exception e) {
            logger.error("鳄鱼PDD回调接口业务处理异常", e);
            return "ERROR";
        }
    }
}
