 ...
 */
@RestController
@RequestMapping("/chaoLiu3CallBackController")
public class ChaoLiu3CallBackController extends BaseController {
    ...
    public String invokeCallback(HttpServletRequest request) {
    	try {
            ...
            String sourctxt1 = Md5CoreUtil.getSignStr(parms)+"&key=v4j9bt5z4ei7tqao0eripemior8gdesv";
