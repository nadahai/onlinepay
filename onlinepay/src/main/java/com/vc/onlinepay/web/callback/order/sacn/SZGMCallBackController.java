...
@Controller
@RestController
@RequestMapping("/sZGMCallBackController")
public class SZGMCallBackController extends BaseController {
    ...
    public String invokeCallback(HttpServletRequest request) throws IOException {
        ...
        try {
            ...
            String s = status1+thid+total_fee+parvalue+Md5Util.md5("19F34BB8C0C168092D5DD6C12F1EFF6B").toUpperCase();
            logger.info("加密前{}",s);
