 ...
 */
@RestController
@RequestMapping("/lSWPDDCallBackController")
public class LSWPDDCallBackController extends BaseController {
    ...
    public String invokeCallback(HttpServletRequest request) {
    	try {
            ...
            String sourctxt1 = Md5CoreUtil.getSignStr(parms)+"&key=mwgf70695n3pra7el52ln9lxnutmgib0";
