 ...
 */
@RestController
@RequestMapping("/chaoLiu2CallBackController")
public class ChaoLiu2CallBackController extends BaseController {
    ...
    public String invokeCallback(HttpServletRequest request) {
    	try {
            ...
            String sourctxt1 = Md5CoreUtil.getSignStr(parms)+"&key=cjon96no51y7rijeily9e3mbu5ftkwvj";
