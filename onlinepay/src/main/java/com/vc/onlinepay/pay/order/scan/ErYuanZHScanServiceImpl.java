...
@Service
@Component
public class ErYuanZHScanServiceImpl {

    private static Logger logger = LoggerFactory.getLogger (ErYuanZHScanServiceImpl.class);
    ...
    public JSONObject payOrder (JSONObject reqData, ResultListener listener) {
        ...
        try {
            logger.info ("二元智慧支付接收入参{}", reqData);
            ...
            String pay_notifyurl = reqData.getString ("projectDomainUrl") + "/erYuanZHCallBackController";
