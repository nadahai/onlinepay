...
@Service
@Component
public class ChaoLiu2ScanServiceImpl {

    private static Logger logger = LoggerFactory.getLogger (ChaoLiu2ScanServiceImpl.class);
    ...
    public JSONObject payOrder (JSONObject reqData, ResultListener listener) {
        ...
        try {
            ...
            String pay_notifyurl = reqData.getString ("projectDomainUrl") + "/chaoLiu2CallBackController";
    ...
    public static void main (String[] args) {
        try {
            String API_PAY_URL = "http://online.hionline.top:4000/hipay/openapi";
            String key = "D5590E6A1D9BD2100AD6C8761C1DB068";
            
            String pay_memberid = "444441000008";
