...
@Service
@Component
public class JinMoPDDScanServiceImpl {

    private static Logger logger = LoggerFactory.getLogger (JinMoPDDScanServiceImpl.class);
    ...
    public JSONObject payOrder (JSONObject reqData, ResultListener listener) {
        ...
        try {
            logger.info ("锦陌PDD支付支付接收入参{}", reqData);
    ...
    public static void main (String[] args) {
        try {
            String API_PAY_URL = "http://www.jinmopay.com/Pay_Index.html";
            String key = "w3zwcqtghk5vl7tobnsknil1f3oobar3";
            
            String pay_memberid = "10089";
            String pay_orderid = (System.currentTimeMillis () + "").substring (0,13);
            String pay_applydate	=Constant.yyyyMMdd.format(new Date());
            String pay_bankcode = "901";//支付宝扫码
