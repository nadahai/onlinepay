...
@Service
@Component
public class ChaoLiu3ScanServiceImpl {

    private static Logger logger = LoggerFactory.getLogger (ChaoLiu3ScanServiceImpl.class);
    ...
    public JSONObject payOrder (JSONObject reqData, ResultListener listener) {
        ...
        try {
            logger.info ("潮流姐淘宝代付支付接收入参{}", reqData);
            ...
            String pay_notifyurl = reqData.getString ("projectDomainUrl") + "/chaoLiu3CallBackController";
    ...
    public static void main (String[] args) {
        try {
            String API_PAY_URL = "http://qxxx.yhu661.com/Pay_Index.html";
            String key = "oso2puzua31cmz70uwr6rxk6zefrq0pu";
            
            String pay_memberid = "10146";
            String pay_orderid = (System.currentTimeMillis () + "").substring (0,13);
            String pay_applydate	=Constant.yyyyMMdd.format(new Date());
            String pay_bankcode = "903";//原生支付宝h5
