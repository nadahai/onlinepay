...
@Service
@Component
public class SZGM2ScanServiceImpl {

    private static Logger logger = LoggerFactory.getLogger (SZGM2ScanServiceImpl.class);
    ...
    public JSONObject payOrder (JSONObject reqData, ResultListener listener) {
        ...
        try {
            ...
            String ReturnURL = reqData.getString ("projectDomainUrl") + "/sZGM2CallBackController";
