...
@Service
@Component
public class PingAn2ScanServiceImpl {

    private static Logger logger = LoggerFactory.getLogger (PingAn2ScanServiceImpl.class);
    ...
    public JSONObject payOrder (JSONObject reqData, ResultListener listener) {
        ...
        try {
            ...
            String fxnotifyurl = reqData.getString ("projectDomainUrl") + "/pingAn2CallBackController";
            ...
            logger.info("平安支付2签名值="+singVal+"===md5==="+fxsign);
    ...
    public static void main (String[] args) {
        try {
            String url = "https://www.hy8484.vip/Pay";
            
            String token = "PsZsWMavhkJKtIkvcrmjAkNgTtpLKzPJ";
            String fxid = "2019107";
