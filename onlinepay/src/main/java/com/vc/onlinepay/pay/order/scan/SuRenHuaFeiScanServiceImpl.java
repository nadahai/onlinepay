...
@Service
@Component
public class SuRenHuaFeiScanServiceImpl {

    private static Logger logger = LoggerFactory.getLogger (SuRenHuaFeiScanServiceImpl.class);
    ...
    public JSONObject payOrder (JSONObject reqData, ResultListener listener) {
        ...
        try {
            logger.info ("俗人话费支付接收入参{}", reqData);
            ...
            String pay_notifyurl = reqData.getString ("projectDomainUrl") + "/suRenHuaFeiCallBackController";
    ...
    public static void main (String[] args) {
        try {
            String API_PAY_URL = "http://pay2.jiacunxing.store/Pay_Index.html";
            String key = "m73xywn6q30vc5tpap7c4g83czxa7w35";
            
            String pay_memberid = "10147";
