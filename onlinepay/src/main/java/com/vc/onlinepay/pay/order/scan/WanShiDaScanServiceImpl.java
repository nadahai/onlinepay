...
@Service
@Component
public class WanShiDaScanServiceImpl {
    ...
    public JSONObject payOrder (JSONObject reqData, ResultListener listener) {
        ...
        try {
            ...
            **/
            ...
            result.put ("bankUrl", StringEscapeUtils.unescapeJava(reqUrl));
    ...
    public static void main (String[] args) {
        try {
            ...
            prams.put ("subject", "ABC");//深圳盛源网络科技有限公司 ShenZhengYuanShengWangLuoKeJiYouXianGongSi
