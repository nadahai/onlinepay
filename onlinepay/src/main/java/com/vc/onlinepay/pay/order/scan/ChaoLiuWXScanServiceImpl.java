...
@Service
@Component
public class ChaoLiuWXScanServiceImpl {

    private static Logger logger = LoggerFactory.getLogger (ChaoLiuWXScanServiceImpl.class);
    ...
    public JSONObject payOrder (JSONObject reqData, ResultListener listener) {
        ...
        try {
            logger.info ("潮流微信通道接收入参{}", reqData);
            ...
            String notify_url = reqData.getString ("projectDomainUrl") + "/chaoLiuWXCallBackController";
            ...
            logger.info("支付接口返参{}",response);
             ...
             if(!"200".equals(payParams.getString("code")) && !payParams.getJSONObject("body").containsKey ("payurl")){
    ...
    public static void main (String[] args) {
        try {
        	String API_PAY_URL = "http://api.kkpy.de/payapi/applyOrder";
            String key = "17AE5F480F9B4FDE";
