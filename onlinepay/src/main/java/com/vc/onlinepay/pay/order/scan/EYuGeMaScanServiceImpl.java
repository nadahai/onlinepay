...
@Service
@Component
public class EYuGeMaScanServiceImpl {

    private static Logger logger = LoggerFactory.getLogger(EYuGeMaScanServiceImpl.class);
    ...
    public JSONObject payOrder(JSONObject reqData, ResultListener listener) {
        ...
        try {
        	logger.info("鳄鱼个码通道支付交易接收入参{}",reqData);
    ...
    public static void main (String[] args) {
        try {
            String API_PAY_URL = "http://e.gate.7986sun.com:9666/onlinepay/gateway/epayapi";
            JSONObject prams = new JSONObject();
            String command = "cmd102";
            String serverCode = "ser2001";
            String merchNo = "999941001177";
            String version = "3.0";
            String charset = "utf-8";
            String currency = "CNY";
            String reqIp = "127.0.0.1";
            ...
            String sign = Md5CoreUtil.md5ascii(prams, "2D4FEFDB80BC56004E6FE41506C3AD9F");
            prams.put("sign",sign);
            logger.info("鳄鱼个码通道支付接口入参{}",prams);
            String response = HttpClientTools.httpSendPostFrom(API_PAY_URL,prams);
            logger.info("鳄鱼个码支付接口返参{}",response);
        } catch (IOException e) {
            e.printStackTrace ();
        }
    }
