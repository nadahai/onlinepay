...
<head>
  ...
  <title>xpay收银台</title>
  <link rel="stylesheet" href="http://www.sichanghui.com/Public/cashier/css/app-service-nav.ltr.css">
  <link rel="stylesheet" href="http://www.sichanghui.com/Public/payment/cashier/css/transfer.ltr.css">
  <link rel="stylesheet" href="http://www.sichanghui.com/Public/payment/css/layer.css" id="layuicss-skinlayercss">
  <link nonce="" rel="stylesheet" type="text/css" href="http://www.sichanghui.com/Public/payment/cashier/css/vx-header-footer.min.css">
  <link nonce="" rel="stylesheet" type="text/css" href="http://www.sichanghui.com/Public/payment/cashier/css/cw-notifications.min.css">
  <meta name="__hash__" content="9ceb591e63a771cdd3c6db5c2850f3a1_7515963ccfcf35f97076a609b1dd3f26"/>
</head>
...
<div class="vx_globalNav-main globalNav-main js_globalNavView js_ppLogo" role="banner">
  <div class="vx_globalNav-container" style="line-height:100%;">
    <a href="javascript:void(0)" name="ppLogo" style="padding-top:10px;">
      <img src="http://www.sichanghui.com/Public/payment/cashier/img/shouyintai.png" height="50">
    </a>
    ...
    <div class="vx_globalNav-navContainer">
      <nav class="vx_globalNav-nav" role="navigation">
        <ul class="vx_globalNav-list">
          <li class=""><a href="#" target="_self" name="summary" class="vx_globalNav-links js_summary">xpay官方收银台</a></li>
          <li><a style="color:red;" href="http://wpa.qq.com/msgrd?v=3&amp;uin=1838245142&amp;site=qq&amp;menu=yes" target="_blank" name="summary">联系QQ: 1838245142</a></li>
        </ul>
    ...
    <section class="mainContents row transfer " id="transfer">
      <div id="react-transfer-container">
        <div data-reactroot="" class="react-p2p_wrapper">
          ...
          <div>
            <!-- react-empty: 4 -->
            <form id="payForm" class="previewPage pageWrapper_1epv95t" action="http://online.toxpay.com/xpay/wechat/alipayPayTest" method="post">
              <div class="headerBox_dpbx39">
                <div class="recipientHeader css-1ba9780">
                  <div class="css-1lmy3ja">
                    <div class="css-1jjxyny">
                      <img src="http://www.sichanghui.com/Public/payment/cashier/img/logo.png" width="100">
                    </div>
                  </div>
                  <p class="vx_text-5" title=""></p>
                </div>
                <div>
                  <div>
                ...
                <div class="whiteBox_5k4pn1">
                  <div class="css-1gb3gzr">
                    ...
                    <select name="payList" id="payList" class="vx_form-control">
                      <option value="2">支付宝扫码</option>
                    </select>
                  </div>
                </div>
                <input type="hidden" name="mchid" id="mchid" value="10027">
                <div class="submitButtonWrapper_1ntyrs8">
                  <button type="button" class="vx_btn submitButton_1sxl9gz preview-getFundingOptions" id="pay">立即支付</button>
                </div>
                <input type="hidden" name="__hash__" value="9ceb591e63a771cdd3c6db5c2850f3a1_7515963ccfcf35f97076a609b1dd3f26"/>
            </form>
          </div>
        </div>
      </div>
    ...
    <div class="vx_globalFooter-content">
      ...
      <div class="vx_globalFooter_secondary">
        <p class="vx_globalFooter-copyright">©
          <span dir="ltr">{if condition="date('Y') eq '2017'"}2017{else/}2017-{:date('Y')}{/if}</span>{:sysconf('site_name')} 保留所有权利。</p>
...
<script type="text/javascript" src="http://www.sichanghui.com/Public/js/jquery-1.10.2.min.js"></script>
<script type="text/javascript" src="http://www.sichanghui.com/Public/payment/js/dialogJs.js"></script>
<script type="text/javascript" src="http://www.sichanghui.com/Public/payment/js/layer.js"></script>
