 ...
 */
public class XkPddGoods implements Serializable{
	/**
	 * @描述:TODO
	 */
	private static final long serialVersionUID = -8611552559766702422L;
	private long id;
    ...
    public XkPddGoods(long id, double dayTradeAmount) {
        this.id = id;
